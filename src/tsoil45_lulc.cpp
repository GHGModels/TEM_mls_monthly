...
{
  // Ref: Saxton and Rawls, 2006. Soil water characteristic estimates by texture and organic matter for hydrologic solutions. 
  //question: how does this affect soil root? Where is the literature support?
  double pota, potb;
