...
//come back to remove the following lines MJ MLS;
...
//  pdstate[I_FBC] = (veg.getLTRLC()+veg.getLTRSC()+veg.getLTRHC())
  pdstate[I_SOLC] = (veg.getLTRLC()+veg.getLTRSC()+veg.getLTRHC())
                    + veg.getLTRSEEDC() 
...
//    pdstate[I_FBN] =   veg.getLTRLN()
    pdstate[I_SOLN] =   veg.getLTRLN()
                    ...
                    + veg.getLTRSEEDN()
                    + ag.getSLASHN()
//                    + soil.getSONINPFB()    //for simplication purpose swap with following line MJ MLS;
                    + soil.getSONINP()
                    - y[I_DONPRODFB]
                    - ag.getSCONVRTFLXN()
                    - ag.getNSRETENT()
...
//commented out for simpler calibration modifications for now MJ MLS;
/*
  if( y[I_FBC] - prevy[I_FBC] != y[I_LTRLC] + y[I_LTRSC] + y[I_LTRHC] + y[I_LTRSEEDC] + y[I_LTRRC] * soil.getFRROOTC_FB(veg.cmnt)
                  - y[I_DOCPRODFB] + ag.getSLASHC() - ag.getSCONVRTFLXC()
                  - y[I_RHFB])
  {
    y[I_RHFB] = y[I_LTRLC]
              + y[I_LTRSC]
