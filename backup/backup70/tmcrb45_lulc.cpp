...
{
  kdc =  kdfb[pcmnt];   //commented out for now MJ MLS;
//  kdc = (kdfb[pcmnt] + kdfb[pcmnt]/kdfbam[pcmnt] + kdfb[pcmnt]/kdfbmn[pcmnt])/3.0 ;    //not sure if this way is the correct way or not MJ MLS;
