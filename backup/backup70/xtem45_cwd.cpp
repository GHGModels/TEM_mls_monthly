...
/// Vegetation inputs and output selection
  ...
  if( 1 == temflag )
  {
    ...
    ifilename = telmnt[0].tem.goxml.getXMLstring( telmnt[0].tem.gofile, "gofile", "finitc" );
    finitc = fopen( ifilename.c_str(), "r" );
    flog1 << ifilename << " opened for initial condition " << endl;
    ...
    ifilename = telmnt[0].tem.goxml.getXMLstring( telmnt[0].tem.gofile, "gofile", "fboundc" );
    fboundc = fopen( ifilename.c_str(), "r" );
    flog1 << ifilename << " opened for boundary cond " << endl;
...
cout << " veg.cmnt = " << telmnt[0].tem.veg.cmnt << endl;
