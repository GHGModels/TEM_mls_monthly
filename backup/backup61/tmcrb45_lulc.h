...
*/
     ...
     // kd ****************************************************  //Decomposition rate (month-1);

     inline double getKDFB( const int& pcmnt )
     {
       return kdfb[pcmnt];
     }

     inline void setKDFB( const double& pkdfb,
                         const int& pcmnt )
     {
       kdfb[pcmnt] = pkdfb;
     }

     inline double getKDAM( const int& pcmnt )
     {
       return kdam[pcmnt];
     }

     inline void setKDAM( const double& pkdam,
                         const int& pcmnt )
     {
       kdam[pcmnt] = pkdam;
     }
     ...
     inline double getKDMN( const int& pcmnt )
     {
       return kdmn[pcmnt];
     }

     inline void setKDMN( const double& pkdmn,
                         const int& pcmnt )
     {
       kdmn[pcmnt] = pkdmn;
     }
     ...
     //kdfbam and kdfbmn coefficients ************************** //fixed values     

     inline double getKDFBAM( const int& pcmnt )
     {
       return kdfbam[pcmnt];
     }

     inline void setKDFBAM( const double& pkdfbam,
                         const int& pcmnt )
     {
       kdfbam[pcmnt] = pkdfbam;
     }


     inline double getKDFBMN( const int& pcmnt )
     {
       return kdfbmn[pcmnt];
     }

     inline void setKDFBMN( const double& pkdfbmn,
                         const int& pcmnt )
     {
       kdfbmn[pcmnt] = pkdfbmn;
     }
...
//     double kdb[MAXCMNT];
     ...
     double kdam[MAXCMNT];
     double kdmn[MAXCMNT];
     double kdfbam[MAXCMNT];
     double kdfbmn[MAXCMNT];
