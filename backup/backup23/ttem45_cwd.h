...
// 5 Water Pools (MAXWSTAT)
       ...
       I_DOCPROD,  I_DOCPRODFB,I_DOCPRODAM,I_DOCPRODMN,I_LCHDOC,
       I_DONPROD,  I_DONPRODFB,I_DONPRODAM,I_DONPRODMN,

       I_LCHDON,   I_NFIXS,    I_NFIXN,    I_FRDL,
       I_FCO2,     I_FH2O,     I_TEMP,     I_FO3,      I_LCHDIN,
// 82 C&N Fluxes (NUMEEQ-MAXESTAT)
...
// 27+5+82+11 = 125 = NUMEQ; no variables below this point should appear in
