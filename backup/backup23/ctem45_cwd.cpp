...
#include "ttem45_cwd.h"    // Ttem45 Class
...
//added for MJ MLS, position not right;
    case T_KDFS:     move( VPARAMS_ROW+2, 20 );

                    printw( "KDFS = %8.6lf                    ",
                            tem.microbe.getKDFS( tem.veg.cmnt ) );
                    break;

    case T_KDSLOW:     move( VPARAMS_ROW+2, 20 );

                    printw( "KDSLOW = %8.6lf                    ",
                            tem.microbe.getKDSLOW( tem.veg.cmnt ) );
                    break;
...
//  tcalvar[T_KDC]  =  tem.microbe.getKDC();
  tcalvar[T_KDFS]  =  tem.microbe.getKDFS( tem.veg.cmnt );
  tcalvar[T_KDSLOW]  =  tem.microbe.getKDSLOW( tem.veg.cmnt );
...
/*
    case T_KDC:     tem.microbe.setKDC( (tcalvar[T_KDC] * factor) );
                    break;
*/
    case T_KDFS:     tem.microbe.setKDFS( (tcalvar[T_KDFS] * factor), tem.veg.cmnt );
                    break;

    case T_KDSLOW:     tem.microbe.setKDSLOW( (tcalvar[T_KDSLOW] * factor), tem.veg.cmnt );
                    break;
